...
| `isFunctionStr` | (`aFuncString`: `string`) => `boolean` | Determines if a string represents a valid JavaScript function. **`Example`** ```ts isFunctionStr('function add(x, y) { return x + y; }') // true isFunctionStr('const x = 5;') // false ``` |
| `isInheritedFrom` | `any` | - |
...
[src/index.js:1](https://github.com/snowyu/util-ex.js/blob/0666556/src/index.js#L1)
